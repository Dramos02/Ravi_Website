...
class firebaseRDB
{
  ...
  public function insert($table, $data)
  {
    ...
    // Decode the JSON response to get the Firebase-generated ID
    $response = json_decode($grab, true);

    // Check if the response contains a name field (Firebase-generated ID)
